...
import { calculateAnalytics } from '../services/analytics.service';
...
export const calculateAnalyticsController = asyncHandler(async (req: Request, res: Response) => {
  const calculations = await calculateAnalytics(req.body);
